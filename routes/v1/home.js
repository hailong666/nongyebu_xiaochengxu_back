...
router.get('/getRecommendWine', ctrl.home.getRecommendWine)

router.get('/getPicture', ctrl.home.getPicture)

router.get('/deletePicture/:id', ctrl.home.deletePicture)

router.post('/addPicture', ctrl.home.addPicture)
