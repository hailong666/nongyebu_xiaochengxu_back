...
router.get('/getGoodsListByType', ctrl.goods.getGoodsListByType)
/**
...
router.post('/addGoods', ctrl.goods.addGoods)

router.post('/deleteGoods/:id', ctrl.goods.deleteGoods)

router.post('/updateGoods/:id', ctrl.goods.updateGoods)
